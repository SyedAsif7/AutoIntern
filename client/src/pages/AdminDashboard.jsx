      ...
      <div className="w-72 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0 hidden md:flex shadow-sm">
        ...
        <div className="p-6 mt-auto border-t border-slate-100">
          <div className="bg-brand/5 p-5 rounded-[2rem] border border-brand/10">
            ...
            <button className="w-full py-2.5 bg-white border border-brand/20 text-brand text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-brand hover:text-white transition-all">Sign Out</button>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
            ...
            <div className="flex gap-3">
              <button className="px-8 py-4 bg-white border border-slate-200 text-slate-600 font-black rounded-2xl text-xs hover:bg-slate-50 transition-all shadow-sm flex items-center gap-2">
                <Download className="h-4 w-4" /> Export CSV
              </button>
              <button className="px-8 py-4 bg-slate-900 text-white font-black rounded-2xl text-xs hover:bg-slate-800 transition-all shadow-2xl shadow-slate-200 flex items-center gap-2">
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button className="px-8 py-4 bg-brand text-white font-black rounded-2xl text-sm shadow-xl shadow-indigo-100 hover:bg-brand-dark transition-all flex items-center gap-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <div className="relative">
            ...
            <input type="text" placeholder="Search by name, email or college..." className="pl-12 pr-6 py-3 bg-white border border-gray-100 rounded-2xl text-sm font-medium focus:ring-brand w-80 shadow-sm" />
          </div>
